        ...
        <div className={aboutStyles.about} id="about">
            <div className={aboutStyles.container}>
                ...
                <div className={aboutStyles.contentCard}>
                    Coming from a background in music with a degree in recording engineering, classical training in percussion, and a lifelong passion for coding and all things computers, I’ve accumulated a wealth of broadly transferable skills in life. Disparate coordinates, as these seem to be, turn out to yield closely knit assets in both life and career. With the experience accumulated over the last decade as a freelance recording engineer/producer and musician, I have thrived where being agile, team-oriented, and creative are essential skills to succeeding. Over the years I’ve transitioned from the all-night engineer at local studios to a husband and father, and this metamorphosis has uncovered a yearning for stability and ownership in something new. 
