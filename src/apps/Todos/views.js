...
const renderTodos = () => {
    ...
    if (filteredTodos.length > 0) {
        ...
        messageEl.classList.add(todoStyles.emptyMessage)
...
const generateTodoDOM = (todo) => {
    ...
    // Setup container
    todoEl.classList.add(todoStyles.listItem)
    containerEl.classList.add(todoStyles.listItemContainer)
    todoEl.appendChild(containerEl)

    // Configure button
    removeButton.textContent = 'remove'
    removeButton.classList.add(todoStyles.button, todoStyles.buttonText)
...
const generateSummaryDOM = (incompleteTodos) => {
    ...
    summary.classList.add(todoStyles.listTitle)
